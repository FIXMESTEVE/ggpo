...
void VectorWar_Init(HWND hwnd, unsigned short localport, int num_players, GGPOPlayer *players, int num_spectators, EOS_ProductUserId localProductUserId, EOS_HPlatform hPlatform);
